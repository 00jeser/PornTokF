...
namespace PornTokF.Models
{
    ...
    public class PhotoViewModel : INotifyPropertyChanged
    {
        ...
        public PhotoViewModel()
        {
            ...
            {
                Device.OpenAsync(new Uri(Photo.Sample_url));
            });
            ...
            {
                await Microsoft.Maui.ApplicationModel.DataTransfer.Share.RequestAsync("https://api.rule34.xxx/index.php?page=post&s=view&id=" + Photo.Id);
            });
            Aspect = new Command(async () =>
            {
                await Task.Run(() => aspect = aspect == Microsoft.Maui.Aspect.AspectFill ? Microsoft.Maui.Aspect.AspectFit : Microsoft.Maui.Aspect.AspectFill);
            });
